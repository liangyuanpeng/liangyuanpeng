...
- 🔭 目前我正在开发开源项目[SOP(SocketIO-on-Pulsar)](https://github.com/yunhorn/sop)和[vmbackup-sidecar](https://github.com/yunhorn/vmbackup-sidecar) 
...
- 🌱 与此同时我正在学习边缘计算,研究两个CNF项目(暂停中)[Openyurt](https://github.com/alibaba/openyurt)和[KubeEdge](https://github.com/kubeedge/kubeedge),如果你已经有相关经验或感兴趣的同学欢迎与我分享一下内容!
